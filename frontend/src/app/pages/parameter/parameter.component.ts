...
export class ParameterComponent {
  ...
  readonly parameters: PortalParameter[] = [
    // Portal - Allgemein
    { id: 'pm1', key: 'portal.name', label: 'Portal Name', description: 'Anzeigename des Portals', appId: 'portal', appName: 'Portal', group: 'Allgemein', type: 'string', value: 'adesso health Portal', defaultValue: 'adesso health Portal', required: true, validationRules: [], sensitive: false, hotReload: true, lastModified: '2026-03-10', lastModifiedBy: 'Anna Schneider', createdAt: '2025-01-01' },
    ...
    // Portal - E-Mail
    { id: 'pm7', key: 'portal.email.sender', label: 'Absender E-Mail', description: 'Standard-Absenderadresse', appId: 'portal', appName: 'Portal', group: 'E-Mail', type: 'email', value: 'noreply@adesso-health.de', defaultValue: 'noreply@adesso-health.de', required: true, validationRules: [], sensitive: false, hotReload: false, lastModified: '2026-01-15', lastModifiedBy: 'Anna Schneider', createdAt: '2025-01-01' },
    ...
    { id: 'pm25', key: 'api.cors.origins', label: 'CORS Origins', description: 'Erlaubte CORS Origins', appId: 'api', appName: 'API Gateway', group: 'Allgemein', type: 'string', value: 'https://portal.adesso-health.de', defaultValue: '*', required: true, validationRules: [], sensitive: false, hotReload: false, lastModified: '2026-01-20', lastModifiedBy: 'Michael Braun', createdAt: '2025-07-01' },
