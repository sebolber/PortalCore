  ...
  private readonly allApps: PortalApp[] = [
    {
      ...
      category: 'ABRECHNUNG', marketSegment: 'KOSTENTRAEGER', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'FALLMANAGEMENT', marketSegment: 'KOSTENTRAEGER', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'VERWALTUNG', marketSegment: 'STEUERUNG_PRUEFSTELLEN', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'VERWALTUNG', marketSegment: 'KOSTENTRAEGER', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'KI_AGENTEN', marketSegment: 'ABRECHNUNGSDIENSTLEISTER', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'ANALYSE', marketSegment: 'LEISTUNGSERBRINGER', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'INTEGRATION', marketSegment: 'INFRASTRUKTUR_PLATTFORMEN', appType: 'integration', vendor: 'adesso_se', vendorName: 'adesso SE',
    ...
    },
    {
      ...
      category: 'KOMMUNIKATION', marketSegment: 'INFRASTRUKTUR_PLATTFORMEN', appType: 'integration', vendor: 'adesso_se', vendorName: 'adesso SE',
    ...
    },
    {
      ...
      category: 'FORMULARE', marketSegment: 'LEISTUNGSERBRINGER', appType: 'anwendung', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'INTEGRATION', marketSegment: 'ABRECHNUNGSDIENSTLEISTER', appType: 'integration', vendor: 'adesso_health', vendorName: 'adesso health',
    ...
    },
    {
      ...
      category: 'ANALYSE', marketSegment: 'OEFFENTLICHE_HAND_FORSCHUNG', appType: 'anwendung', vendor: 'one_adesso', vendorName: 'one adesso',
  ...
  private generateChangelog(app: PortalApp): { version: string; date: string; changes: string[] }[] {
    return [
      ...
      },
      {
        ...
        date: '2025-09-10',
        changes: [
          'Initiale Veroeffentlichung im adesso health Portal',
